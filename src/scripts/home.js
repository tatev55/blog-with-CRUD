...
function createBloggerCard(blogger) {
    ...
    const blogCard =  UI.createElement('div', { class: 'blogger w-200px h-200px display-flex fd-column jc-space-between ai-center', id: `blogger-${blogger.id}` }, [
            UI.createElement('img', { src: "https://png.pngtree.com/png-vector/20220624/ourmid/pngtree-unknown-user-question-mark-about-png-image_5178068.png", class: 'blogger_avatar w-100px h-100px transition-5' }),
...
function createContainer() {
    ...
    loadBloggers().then(bloggers => {
        renderItems(bloggers, '.bloggers__list', createBloggerCard);
    });
}
